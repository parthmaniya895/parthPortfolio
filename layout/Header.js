            ...
            <div className="logo">
              <Link className="navbar-brand me-0" href="/">
                <svg width="28" height="25" viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.7373 0.706432H2.38761C1.22999 1.13089 1.40684 2.10522 1.63998 2.53933L4.9199 6.39806C5.74952 7.36275 6.92161 7.49137 7.40396 7.4351H14.5908C15.2468 7.49298 15.4751 8.07018 15.5073 8.35155V9.43681C15.3336 10.2664 14.5828 10.3935 14.2291 10.3533H7.40396C6.22704 10.4883 5.14499 9.65387 4.75108 9.21976L1.97761 6.03631C0.646353 5.51538 0.104523 6.36591 1.52588e-05 6.85629V23.6659C0.482357 24.92 1.51939 24.6547 1.97761 24.3653L5.73988 21.2783V16.5996C5.72058 15.8664 6.50358 15.5063 6.8975 15.4178H11.6727C12.8303 15.3214 13.8593 14.429 14.2291 13.9949L21.4642 3.914C20.268 1.1743 17.8145 0.634081 16.7373 0.706432Z" fill="#1A1F2C" />
                  <path d="M27.5339 23.5478V1.6495C26.9744 0.0674188 25.8216 0.636582 25.3152 1.11892L15.4995 14.6486C14.284 16.3657 12.6457 16.9076 11.9784 16.9638H9.34967C8.17276 17.2725 8.16793 18.2179 8.31263 18.652L13.1119 24.3437C13.8258 24.826 14.4062 24.5446 14.6072 24.3437L21.8423 16.795V21.2084L25.6528 24.3437C26.7333 24.9804 27.3571 24.0784 27.5339 23.5478Z" fill="#4770FF" />
                </svg>
                {/* <svg
                  width={24}
                  height={24}
                ...
                <span>
                  Parth<span className="primary">Maniya</span>
                </span>
              </Link>
            </div>
            <div
