...
const ProfileCard = () => {
  ...
  const socialItems = [
    {
      id: 1, url: "https://www.linkedin.com/in/parthmaniya", name: "LinkedIn", icon: "fab fa-linkedin"},
  ...
  return (
    <div className="card profile-card">
      <div className="card-body">
        ...
        <div className="text">
          <h3 className="card-title">Parth Maniya 👋</h3>
          <p>
          ...
          <div className="common-button-groups">
            ...
            <button
              ...
              data-clipboard-text="hello@parthmaniya.com"
              onClick={() => toggleBtn()}
            >
              <svg
                className="icon"
